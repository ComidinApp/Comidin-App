...
const getClassNameInput = (param) => {
  ...
  if (param === 'SECONDARY') return 'w-full bg-comidin-light-orange rounded-2xl py-3 items-center mb-3';
...
const getClassNameText = (param) => {
  ...
  if (param === 'SECONDARY') return 'text-comidin-dark-orange text-lg font-semibold';
  if (param === 'TERTIARY') return 'text-black text-shadow-lg text-lg font-semibold';
